          ...
          <div className="w-full md:grid grid-cols-1 md:grid-cols-2 place-items-start gap-10 mb-10">
            {currentProjects.map((project) => (
              <motion.div
                ...
                className="w-full mb-10 md:mb-0 bg-[--card]"
                key={project.id}
              >
        ...
        <CardFooter className="flex-col">
          <div className="w-full flex justify-center py-10">
            <Link
              ...
              target="_blank"
              className="flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium w-[200px] h-[52px] bg-[#390895] hover:bg-[#c62df3]"
            >
              Visit github
            </Link>
          </div>
